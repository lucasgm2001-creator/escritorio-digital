...
import type { ViewMode, DisplayMode, ThemeKey } from '@/components/map/LeadMap'
...
export interface MapPrefs { view: ViewMode; tilt: number; mode: DisplayMode; theme: ThemeKey }

export const DEFAULT_MAP_PREFS: MapPrefs = { view: '3d', tilt: 15, mode: 'individual', theme: 'lima' }
const KEY = 'mapPrefs'
const CHANGE_EVT = 'mapPrefs-change'

// Lê + normaliza (qualquer valor inválido cai no default). Só no client.

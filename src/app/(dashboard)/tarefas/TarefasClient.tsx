...
export function TarefasClient({ tasks, setTasks, deletedIds, linkOptions, currentUser }: Props) {
  ...
  return (
    <div className="h-full overflow-auto bg-bento-bg font-body">
      ...
      {view === 'tarefas' && (
        <div className="xl:hidden px-4 py-4 space-y-3 pb-[calc(8rem_+_env(safe-area-inset-bottom,0px))] lg:pb-[calc(5rem_+_env(safe-area-inset-bottom,0px))]">
          {actionError && (
      ...
      {view === 'tarefas' && (
        <div className="xl:hidden fixed inset-x-0 bottom-[calc(4rem_+_env(safe-area-inset-bottom,0px))] lg:bottom-[env(safe-area-inset-bottom,0px)] z-20 border-t border-bento-border bg-bento-panel/95 backdrop-blur px-3 py-2 flex items-center gap-2">
